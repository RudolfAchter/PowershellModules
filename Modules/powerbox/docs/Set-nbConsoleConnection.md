...
SYNTAX
    Set-nbConsoleConnection [-object] <Object> [[-Id] <Int32>] [[-CustomProperties] <String[]>] [[-Lookup] 
...
AUSGABEN
    ...
    PS C:\>Get-nbConsoleConnection | Foreach {$_.site = 'Seattle'; $_} | Set-nbConsoleConnection
