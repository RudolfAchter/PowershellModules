...
SYNTAX
    Set-nbExportTemplate [-object] <Object> [[-Id] <Int32>] [[-CustomProperties] <String[]>] [[-Lookup] <Hashtable>] 
...
AUSGABEN
    ...
    PS C:\>Get-nbExportTemplate | Foreach {$_.site = 'Seattle'; $_} | Set-nbExportTemplate
