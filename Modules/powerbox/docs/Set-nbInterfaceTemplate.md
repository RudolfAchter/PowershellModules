...
SYNTAX
    Set-nbInterfaceTemplate [-object] <Object> [[-Id] <Int32>] [[-CustomProperties] <String[]>] [[-Lookup] 
...
AUSGABEN
    ...
    PS C:\>Get-nbInterfaceTemplate | Foreach {$_.site = 'Seattle'; $_} | Set-nbInterfaceTemplate
