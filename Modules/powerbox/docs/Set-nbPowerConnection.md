...
SYNTAX
    Set-nbPowerConnection [-object] <Object> [[-Id] <Int32>] [[-CustomProperties] <String[]>] [[-Lookup] <Hashtable>] 
...
AUSGABEN
    ...
    PS C:\>Get-nbPowerConnection | Foreach {$_.site = 'Seattle'; $_} | Set-nbPowerConnection
