...
SYNTAX
    Set-nbConsolePortTemplate [-object] <Object> [[-Id] <Int32>] [[-CustomProperties] <String[]>] [[-Lookup] 
...
AUSGABEN
    ...
    PS C:\>Get-nbConsolePortTemplate | Foreach {$_.site = 'Seattle'; $_} | Set-nbConsolePortTemplate
