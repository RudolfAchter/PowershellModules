...
SYNTAX
    Set-nbVirtualChassis [-object] <Object> [[-Id] <Int32>] [[-CustomProperties] <String[]>] [[-Lookup] <Hashtable>] 
...
AUSGABEN
    ...
    PS C:\>Get-nbVirtualChassis | Foreach {$_.site = 'Seattle'; $_} | Set-nbVirtualChassis
