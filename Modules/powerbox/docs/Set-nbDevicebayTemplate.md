...
SYNTAX
    Set-nbDevicebayTemplate [-object] <Object> [[-Id] <Int32>] [[-CustomProperties] <String[]>] [[-Lookup] 
...
AUSGABEN
    ...
    PS C:\>Get-nbDevicebayTemplate | Foreach {$_.site = 'Seattle'; $_} | Set-nbDevicebayTemplate
