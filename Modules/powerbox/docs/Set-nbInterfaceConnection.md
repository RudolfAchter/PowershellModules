...
SYNTAX
    Set-nbInterfaceConnection [-object] <Object> [[-Id] <Int32>] [[-CustomProperties] <String[]>] [[-Lookup] 
...
AUSGABEN
    ...
    PS C:\>Get-nbInterfaceConnection | Foreach {$_.site = 'Seattle'; $_} | Set-nbInterfaceConnection
