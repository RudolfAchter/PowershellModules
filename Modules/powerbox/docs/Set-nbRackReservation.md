...
SYNTAX
    Set-nbRackReservation [-object] <Object> [[-Id] <Int32>] [[-CustomProperties] <String[]>] [[-Lookup] <Hashtable>] 
...
AUSGABEN
    ...
    PS C:\>Get-nbRackReservation | Foreach {$_.site = 'Seattle'; $_} | Set-nbRackReservation
