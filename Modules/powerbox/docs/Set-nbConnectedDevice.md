...
SYNTAX
    Set-nbConnectedDevice [-object] <Object> [[-Id] <Int32>] [[-CustomProperties] <String[]>] [[-Lookup] <Hashtable>] 
...
AUSGABEN
    ...
    PS C:\>Get-nbConnectedDevice | Foreach {$_.site = 'Seattle'; $_} | Set-nbConnectedDevice
