...
Copyright = '(c) 2019 Achter, Rudolf <rudolf.achter@uni-passau.de>. Alle Rechte vorbehalten.'
...
FunctionsToExport = 'Create-PowershellRepository', 'Get-PowershellRepository', 
               'Register-PowershellRepository', 'Publish-PowershellModule', 
               'Document-PowershellModule'
