...
Function Set-MailboxQuota {
    ...
    Process {
        ...
        $Mailbox | ForEach-Object {
            ...
            $mbstats=Get-MailboxStatistics -Identity $mb.Identity
...
Register-ArgumentCompleter -CommandName Add-MailboxPermission -ParameterName User -ScriptBlock $Global:AdAutocompleters.Mailbox
...
Register-ArgumentCompleter -CommandName New-TeamSharedMailbox -ParameterName SendOnBehalf -ScriptBlock $Global:AdAutocompleters.User
